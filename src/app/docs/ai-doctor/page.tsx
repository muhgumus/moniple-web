...
Equivalent kubectl delete pod api-gateway-7c9f8b -n prod`}
      ...
      <Section title="Accuracy and responsibility">
        <P>
          The Doctor&apos;s findings and proposed actions are generated by a large
          language model. Like any AI output, they can be wrong, incomplete, or a
          poor fit for your specific environment — treat them as a well-informed
          suggestion, not a verdict. That is exactly why nothing runs
          automatically: every action shows its full change, the equivalent{' '}
          <Code>kubectl</Code> command, and a risk level before you approve it.
        </P>
        <P>
          When you approve an action, it runs under your authority — reviewing
          the proposed change and its consequences is your call and your
          responsibility, as covered in our{' '}
